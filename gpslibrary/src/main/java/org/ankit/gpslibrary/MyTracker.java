...
//        }
    ...
    private void fetchLocation(Location location) {
        ...
        try {
            ...
            adLocation.setAddress(addresses.get(0).getAddressLine(0)); // If any additional address line present than only, check with max available address lines by getMaxAddressLineIndex()
            adLocation.setCity(addresses.get(0).getLocality());
            adLocation.setState(addresses.get(0).getAdminArea());
            adLocation.setCountry(addresses.get(0).getCountryName());
            adLocation.setLat(location.getLatitude());
            adLocation.setLng(location.getLongitude());
