...
public class TabSuggestionLocationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TabSuggestionLocationAdapter(int position, List<ItemHomeService.Item> items, Context context, ClickTab clickTab) {
        this.items = items;
