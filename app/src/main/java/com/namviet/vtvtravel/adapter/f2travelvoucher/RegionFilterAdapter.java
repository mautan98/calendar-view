...
public class RegionFilterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ITEM = 0;
    private Context context;
    private ClickItem clickItem;
    private int oldSelected = 1000;
    private List<RegionVoucherResponse.Category> categories;

    public RegionFilterAdapter(List<RegionVoucherResponse.Category> categories, Context context, ClickItem clickItem) {
    ...
    public interface ClickItem {
        void onClickItem(RegionVoucherResponse.Category category);
    }
