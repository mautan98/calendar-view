...
public class TabDiscoverAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TabDiscoverAdapter(int position, List<ItemHomeService.Item> items, Context context, ClickTab clickTab) {
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.f2_item_home_tab_discover, parent, false);
