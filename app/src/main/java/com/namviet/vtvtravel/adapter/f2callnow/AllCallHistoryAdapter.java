...
public class AllCallHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AllCallHistoryAdapter(Context mContext, List<CallNowHistory> callNowHistories, ClickItem clickItem) {
