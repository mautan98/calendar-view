...
import com.namviet.vtvtravel.databinding.FragmentSchedulePreviewBinding;
...
public class ScheduleShoppingFragment extends MainFragment implements Observer {
    private FragmentSchedulePreviewBinding binding;
    private ScheduleTravelAdapter scheduleTravelAdapter;
    private List<Schedule> scheduleList = new ArrayList<>();
    private PlaceViewModel placeViewModel;
    private EndlessRecyclerViewScrollListener scrollListener;

    public static ScheduleShoppingFragment newInstance() {
        ScheduleShoppingFragment fragment = new ScheduleShoppingFragment();
        return fragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_schedule_preview, container, false);
    ...
    protected void initViews(View v) {
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager, 0) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                ...
                if (null != myLocation) {
                    placeViewModel.loadSchedulePlace(myLocation.getLat(), myLocation.getLog(), page);
                }
            }
        };
    ...
    protected void updateViews() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                MyLocation myLocation = MyApplication.getInstance().getMyLocation();
                if (null != myLocation) {
                    placeViewModel.loadSchedulePlace(myLocation.getLat(), myLocation.getLog(), 0);
                }
            }
        }, 150);
    }
