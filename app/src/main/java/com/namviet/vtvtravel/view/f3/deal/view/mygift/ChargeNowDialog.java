...
public class ChargeNowDialog extends BaseDialogBottom {
    private F2DialogSortVoucherBinding binding;

    @SuppressLint("ValidFragment")
    public ChargeNowDialog() {
    }


    @Override
    protected int getLayoutResource() {
        return R.layout.f3_dialog_charge_now;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.f3_dialog_charge_now, container, false);
