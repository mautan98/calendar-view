...
import com.namviet.vtvtravel.databinding.FragmentWhereBinding;
...
public class WhatPlayFragment extends MainFragment implements Observer, TravelSelectListener, CitySelectListener, FilterSelectListener {
    private FragmentWhereBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_where, container, false);
    ...
    protected void initViews(View v) {
        ...
        binding.toolBar.tvTitle.setText(getString(R.string.tv_play));
        ...
        binding.rvWhereGo.setLayoutManager(layoutManager);
        whereGoAdapter = new WhereGoAdapter(getContext(), travelList);
        whereGoAdapter.setTravelSelectListener(this);
        binding.rvWhereGo.setAdapter(whereGoAdapter);

        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            @Override
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                if (null != moreLink) {
                    placeViewModel.loadWhatPlay(mCitySelect, listFilterData, page);
                }

            }
        };
        binding.rvWhereGo.addOnScrollListener(scrollListener);
        updateViews();
    }
    ...
    protected void updateViews() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                placeViewModel.loadFilter(Constants.TypeItemHome.WHAT_PLAY);
            }
        }, Constants.TimeDelay);
                ...
                mActivity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (o instanceof PlaceResponse) {
                            ...
                            placeViewModel.loadWhatPlay(cityList.get(0), listFilterData, 1);
                            placeViewModel.loadWeather(mCitySelect);
                            ...
                            mActivity.setWeatherList(response.getData());
    ...
    public void onSelect(ArrayList<City> list, City city) {
        ...
        placeViewModel.loadWhatPlay(city, listFilterData, 1);
    }
    ...
    public void onSelect(ArrayList<FilterData> list) {
        travelList.clear();
        listFilterData = list;
        placeViewModel.loadWhatPlay(mCitySelect, listFilterData, 1);
    }
