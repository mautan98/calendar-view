    ...
    public void setClickListener() {
        ...
        getBinding().btnConfirm.setOnClickListener(v -> {
            ...
            if (pass1.isEmpty()) {
                ...
                handleValidateFail(getBinding().edtPassword2, getBinding().linearPassword2, "Mật khẩu xác nhận không đúng. Vui lòng kiểm tra và nhập lại", getBinding().tvRetypePassError);
