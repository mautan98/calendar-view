...
import com.namviet.vtvtravel.databinding.F2FragmentOldWqmmBinding;
...
public class OldVQMMWebviewFragment extends BaseFragment<F2FragmentOldWqmmBinding> {
    ...
    public OldVQMMWebviewFragment(String voucherId) {
        this.voucherId = voucherId;
    }

    public OldVQMMWebviewFragment() {
    }

    @Override
    public int getLayoutRes() {
        return R.layout.f2_fragment_old_wqmm;
    }
...
//            mActivity.onBackPressed();
    ...
    public void setScreenTitle() {
        ...
        setDataScreen(TrackingAnalytic.ScreenCode.LUCKY_WHEEL, TrackingAnalytic.ScreenTitle.LUCKY_WHEEL);
    }
}
