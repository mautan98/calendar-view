...
import com.namviet.vtvtravel.databinding.FragmentDetailWhereStayBinding;
...
public class DetailWhereStayFragment extends MainFragment implements Observer, PlaceSelectLisntener, NestedScrollViewListener, PostCommentListener, PhotoSelectListener {
    private FragmentDetailWhereStayBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_detail_where_stay, container, false);
    ...
    protected void updateViews() {
        ...
        if (null != mTravel) {
            binding.ratingBarWhereStay.setRating(mTravel.getStandard_rate());
            showDialogLoading();
