...
import com.namviet.vtvtravel.databinding.FragmentAddPlaceToTripChild2Binding;
...
public class AddPlaceToTripChildFragment2 extends BaseFragment<FragmentAddPlaceToTripChild2Binding> implements Observer {
    ...
    public AddPlaceToTripChildFragment2(String link, String code, String regionId) {
        this.link = link;
        this.code = code;
    ...
    @SuppressLint("ValidFragment")
    public AddPlaceToTripChildFragment2(String link, String code, String regionId, int position) {
        this.link = link;
        this.code = code;
        this.regionId = regionId;
    ...
    public AddPlaceToTripChildFragment2() {
    }

    @Override
    public int getLayoutRes() {
        return R.layout.fragment_add_place_to_trip_child_2;
    }
