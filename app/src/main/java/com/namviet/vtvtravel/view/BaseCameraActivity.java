...
public class BaseCameraActivity extends Activity implements
    ...
    public void onClick(View view) {
        if (view == mStreamingText) {
            if (mStreaming) {
                stopStream();
            } else {
                startStream();
            }
        } else if (view == mFlashView) {
            onFlashClick();
        } else if (view == switchCam) {
            onSwitchCamera();
        }
