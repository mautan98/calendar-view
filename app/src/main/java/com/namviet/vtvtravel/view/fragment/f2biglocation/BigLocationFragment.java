...
public class BigLocationFragment extends BaseFragment<F2FragmentBigLocationBinding> implements Observer {
    ...
    private List<BigLocationBaseResponse.Data.Item> dataListMain = new ArrayList<>();
    ...
    private BigLocationBaseResponse.Data.Region region;
...
//        detailBigLocationAdapter = new DetailBigLocationAdapter(dataListMain, region, mActivity, null, viewModel);
    ...
    public void update(Observable observable, Object o) {
        ...
        if (observable instanceof BigLocationViewModel && null != o) {
            if (o instanceof BigLocationBaseResponse) {
                BigLocationBaseResponse response = (BigLocationBaseResponse) o;
                dataListMain.clear();
