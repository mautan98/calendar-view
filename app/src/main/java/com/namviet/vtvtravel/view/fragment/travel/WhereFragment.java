...
public class WhereFragment extends MainFragment implements Observer, CitySelectListener, FilterSelectListener, TravelSelectListener {
    ...
    protected void initViews(View v) {
        ...
        binding.toolBar.tvTitle.setText(getString(R.string.tv_go));
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                if (null != moreLink) {
                    placeViewModel.loadPlace(mCitySelect, listFilterData, page);
                }
    ...
    protected void updateViews() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                placeViewModel.loadFilter(Constants.TypeItemHome.WHERE_GO);
                ...
                mActivity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (o instanceof PlaceResponse) {
                            ...
                            placeViewModel.loadPlace(mCitySelect, listFilterData, 1);
    ...
    public void onSelect(ArrayList<City> list, City city) {
        ...
        placeViewModel.loadPlace(city, listFilterData, 1);
        placeViewModel.loadWeather(mCitySelect);
    }
