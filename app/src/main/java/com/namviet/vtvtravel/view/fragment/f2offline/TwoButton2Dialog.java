...
public class TwoButton2Dialog extends BaseDialogFragment {
...
//    public static TwoButton2Dialog newInstance(String title, String button, String button2, ClickButton clickButton) {
//        TwoButton2Dialog offlineDialog = new TwoButton2Dialog();
...
//    }
    ...
    public static TwoButton2Dialog newInstance(ClickButton clickButton) {
        TwoButton2Dialog offlineDialog = new TwoButton2Dialog();
        offlineDialog.clickButton = clickButton;
        return offlineDialog;
    }
