...
public class ResultSearchImagesActivity extends BaseActivityNew<ActivitySearchResultContentSpecificBinding> {
    ...
    public BaseFragment initFragment() {
        ResultSearchImagesFragment resultSearchVideoFragment = new ResultSearchImagesFragment();
    ...
    public static void openScreen(Context context, String keyword, String regionID, SearchSuggestionResponse.Data.Item item){
        Intent intent = new Intent(context, ResultSearchImagesActivity.class);
