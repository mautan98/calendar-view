...
import com.namviet.vtvtravel.view.f2.call.ReceiveCallAtOperatorLinPhone;
...
public class LinphoneService extends Service {
    ...
    public static void acceptCall(){
        CallParams params = getCore().createCallParams(sInstance.call);
        params.enableVideo(true);
        sInstance.call.acceptWithParams(params);
    }

    public static void declineCall(){
        try {
            sInstance.call.decline(Reason.fromInt(0));
...
//                    Toast.makeText(LinphoneService.this, "Incoming call received", Toast.LENGTH_LONG).show();
                    // For this sample we will automatically answer incoming calls

                    LinphoneService.this.call = call;
                    ReceiveCallAtOperatorLinPhone.startScreen(LinphoneService.this);
...
//                    CallingAtOperatorLinPhone.startScreen(LinphoneService.this);
                }
            }
        };
