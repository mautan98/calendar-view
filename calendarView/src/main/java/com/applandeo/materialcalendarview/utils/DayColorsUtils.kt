...
fun setCurrentMonthDayColors(
    ...
    when {
        ...
        calendar.isEventDayWithLabelColor(calendarProperties) -> setEventDayColors(
            calendar,
            dayLabel,
            calendarProperties
        )
        calendarProperties.highlightedDays.contains(calendar) -> setHighlightedDayColors(
            dayLabel,
            calendarProperties
        )
...
private fun tintBackgroundColor(dayLabel: TextView, color: Int) {
