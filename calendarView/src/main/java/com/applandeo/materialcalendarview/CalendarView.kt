...
class CalendarView @JvmOverloads constructor(
    ...
    private fun initAttributes() {
        with(calendarProperties) {
            binding.root.setHeaderColor(binding,headerColor)
            binding.root.setHeaderVisibility(binding,headerVisibility)
            binding.root.setAbbreviationsBarVisibility(binding,abbreviationsBarVisibility)
            binding.root.setNavigationVisibility(binding,navigationVisibility)
            binding.root.setHeaderLabelColor(binding,headerLabelColor)
            binding.root.setAbbreviationsBarColor(binding,abbreviationsBarColor)
            binding.root.setAbbreviationsLabels(binding,abbreviationsLabelsColor, firstPageCalendarDate.firstDayOfWeek)
            binding.root.setPagesColor(binding,pagesColor)
            binding.root.setPreviousButtonImage(binding,previousButtonSrc)
            binding.root.setForwardButtonImage(binding,forwardButtonSrc)
