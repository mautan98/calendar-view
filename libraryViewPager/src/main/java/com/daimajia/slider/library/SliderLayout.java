...
public class SliderLayout extends RelativeLayout {
     ...
     */
    private long mSliderDuration = 15000;
    ...
    private boolean indicatorBottom = true;
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorBottom = attributes.getBoolean(R.styleable.SliderLayout_indication_bottom, true);
        ...
        if (indicatorBottom) {
            setPresetIndicator(R.id.default_center_bottom_indicator);
        } else {
            setPresetIndicator(R.id.default_center_bottom_indicator1);
        }
    ...
    public void setPresetIndicator(int presetIndicator) {
