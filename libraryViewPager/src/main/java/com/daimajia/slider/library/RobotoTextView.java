...
public class RobotoTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private void parseAttributes(Context context, AttributeSet attrs) {
        TypedArray values = context.obtainStyledAttributes(attrs, R.styleable.RobotoTv);

        int typefaceValue = values.getInt(R.styleable.RobotoTv_typeface, 0);
        values.recycle();
    ...
    public void setCustomTypeFace(Context context, int typefaceValue) {
        Typeface typedValue = createTypeface(context, typefaceValue);
        this.setTypeface(typedValue);
